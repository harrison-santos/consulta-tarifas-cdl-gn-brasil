...
class ConsultaTarifasSpider(scrapy.Spider):
    name = 'consulta_residencial_comercial'
    ...
    def parse(self, response):
        ...
        comgas_links = [("RESIDENCIAL", "https://www.comgas.com.br/tarifas/residencial"),
                        ...
                        ("GNV", "https://www.comgas.com.br/tarifas/gas-natural-veicular-gnv/"),
        ...
        gasmig_links = [("RESIDENCIAL", "http://www.gasmig.com.br/NossosServicos/Residencial/Paginas/Tarifas.aspx"),
                        ...
                        ('GNV', 'http://www.gasmig.com.br/NossosServicos/Veicular/Paginas/Tarifas.aspx'),
                        ('INDUSTRIAL', 'http://www.gasmig.com.br/NossosServicos/Industrial/Paginas/Tarifas.aspx'),
                        ('COGERACAO E CLIMATIZACAO', 'http://www.gasmig.com.br/NossosServicos/Cogeracao/Paginas/Tarifas.aspx'),
        ...
        sulgas_links = [("INDUSTRIAL", "http://www.sulgas.rs.gov.br/sulgas/industrial/tabela-de-precos"),
                        ...
                        ("VEICULAR", "http://www.sulgas.rs.gov.br/sulgas/veicular")]
        ...
        algas_links = [("INDUSTRIAL", "http://algas.com.br/gas-natural/gas-industrial"),
                       ...
                       ("COGERACAO E CLIMATIZACAO", "http://algas.com.br/gas-natural/geracao-e-cogeracao-de-energia"),
                       ("GNV", "http://algas.com.br/gas-natural/gnv")]
        ...
        scgas_links =[("RESIDENCIAL", "http://www.scgas.com.br/conteudos/tarifar"),
                      ...
                      ("GNV", "http://www.scgas.com.br/conteudos/tarifav"),
    ...
    def envia_sergas(self, response):
        ...
        dados = sergas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
        yield from self.envia_dados(dados, sergas.nome,"COGERACAO E CLIMATIZACAO", "NAO POSSUI", "NAO POSSUI")
        #SERGAS COG
        ...
        dados = sergas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
        yield from self.envia_dados(dados, sergas.nome, "GNV", "NAO POSSUI", "NAO POSSUI")
        #SERGAS VEICULAR
    ...
    def envia_bahiagas(self, response):
        ...
        dados = bahiagas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
        yield from self.envia_dados(dados, bahiagas.nome, "GNV", "NAO POSSUI", "POSSUI")
        #GNV
        ...
        dados = bahiagas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
        yield from self.envia_dados(dados, bahiagas.nome, "COGERACAO E CLIMATIZACAO", "NAO POSSUI", "POSSUI")
        #Geração, Cogeração e Climatização Comercial
    ...
    def envia_gasmig(self, response, segmento_):
        ...
        if segmento_ == "RESIDENCIAL":
            ...
            dados = gasmig.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
            yield from self.envia_dados(dados, gasmig.nome, "GNV", "NAO POSSUI")"""
        ...
        elif segmento_ == 'COGERACAO E CLIMATIZACAO':
    ...
    def envia_compagas(self):
        ...
        links = [
            ...
            ("GNV", "NAO POSSUI", "http://agv.compagas.com.br/index.php?action=uiprecos.index&segmento=3")
            ]
        for link in links:
            segmento = link[0]
            subsegmento = link[1]
    ...
    def envia_sulgas(self, response, segmento_):
        ...
        if(segmento_ == "INDUSTRIAL"):
            ...
            yield from self.envia_dados(dados, sulgas.nome, segmento_, "INDUSTRIAL FIRME", "POSSUI")
            #INDUSTRIAL FIRME
            ...
            vetor_parcelas = sulgas.calcula_imposto_parcela(self.icms, self.pis, self.confins, vetor_parcelas)
            dados = sulgas.organiza_faixa_tarifas_parcelas(vetor_faixa, vetor_tarifas, vetor_parcelas)
            yield from self.envia_dados(dados, sulgas.nome, segmento_, "COGERACAO PPT", "POSSUI")
            #COGERAÇÃO PPT
            ...
            dados = sulgas.organiza_faixa_tarifas_parcelas(vetor_faixa, vetor_tarifas, vetor_parcelas)
            yield from self.envia_dados(dados, sulgas.nome, segmento_, "COGERACAO, CLIMATIZACAO E GERAÇAO HORARIO PONTA", "POSSUI")
            yield from self.envia_dados(dados, sulgas.nome, "COMERCIAL", "COGERACAO, CLIMATIZACAO E GERAÇAO HORARIO PONTA", "POSSUI")#MESMOS VALORES PARA COMERCIAl
            #COGERAÇÃO, CLIMATIZACAO E GERAÇÃO HORARIO PONTA
            ...
            #COMERCIAL GNC
            vetor_faixa = faixa_auxiliar
            vetor_tarifas = response.xpath('/html/body/div[3]/article/div[2]/table[5] / tbody / tr[2] / td[2] / p / text()').extract()
            vetor_tarifas = sulgas.calcula_imposto_tarifa(self.icms, self.pis, self.confins, vetor_tarifas)

            dados = sulgas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
            yield from self.envia_dados(dados, sulgas.nome, segmento_, "GNC", "POSSUI")
            #COMERCIAL GNC
            ...
            #GNC
            vetor_tarifas = response.xpath('/html/body/div[3]/article/div[2]/table[3] / tbody / tr[2] / td[2] / text()').extract()
            vetor_tarifas = sulgas.calcula_imposto_tarifa(self.icms, self.pis, self.confins, vetor_tarifas)
            vetor_parcelas = response.xpath('/html/body/div[3]/article/div[2]/table[3] / tbody / tr[2] / td[3] / p / text()').extract()
            vetor_parcelas = sulgas.calcula_imposto_parcela(self.icms, self.pis, self.confins, vetor_parcelas)
            dados = sulgas.organiza_faixa_tarifas_parcelas(vetor_faixa, vetor_tarifas, vetor_parcelas)
    ...
    def envia_cegas(self):
        ...
        segmentos = [('INDUSTRIAL', 'NAO POSSUI'), ('COGERACAO E CLIMATIZACAO', 'NAO POSSUI'), ('GNV', 'NAO POSSUI'), ('GNV', 'COMPRIMIDO'),
    ...
    def envia_potigas(self, response):
        ...
        dados = potigas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
        yield from self.envia_dados(dados, potigas.nome, "GNV", "NAO POSSUI", "NAO POSSUI")
        #GNV
    ...
    def envia_pbgas(self, response):
        ...
        yield from self.envia_dados(dados, pbgas.nome, "GNV", "NAO POSSUI", "NAO POSSUI")
        #GNV
    ...
    def envia_copergas(self, response):
        ...
        yield from self.envia_dados(dados, copergas.nome, "GNV", "NAO POSSUI", "POSSUI")
        #GNV

        #COGERACAO E CLIMATIZACAO
        ...
        dados = copergas.organiza_faixa_tarifas_parcelas(vetor_faixa, vetor_tarifas, vetor_parcelas)
        yield from self.envia_dados(dados, copergas.nome, "COGERACAO E CLIMATIZACAO", "NAO POSSUI", "POSSUI")
        #COGERACAO E CLIMATIZACAO
    ...
    def envia_algas(self, response, segmento_):
        ...
        if segmento_ == "INDUSTRIAL":
            ...
            dados = algas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
            yield from self.envia_dados(dados, algas.nome, "COGERACAO E CLIMATIZACAO", "NAO POSSUI", "POSSUI")

        elif segmento_ == 'GNV':
            vetor_faixa = faixa_auxiliar
            vetor_tarifas = response.xpath('//*[@id="acontent"]/section[2]/div/div/div[2] / table / tbody / tr[3] / td[position() >= 2] / text()').extract()
            dados = algas.organiza_faixa_tarifas(vetor_faixa, vetor_tarifas)
            yield from self.envia_dados(dados, algas.nome, "GNV", "NAO POSSUI", "NAO POSSUI")
        ...
        for i in range(0, len(dados), 1):#percorrer dados pegando sempre o valor de faixa
            ...
            if 'a' or 'à' in dados[i][1]:#se possuir algum tipo de divisor entre as faixas #ISDIGIT()
                ...
                yield{#Para cada valor envie as mesma informações.
                    ...
                    "FXA_FIM": valor[1],
                    "FXA_IGUAL": fxa_igual,
                    "TARIFA S/IMPOSTO": dados[i][2],
                    "VOLUME": volume,
                    "VOLUME_ACUM": volume_acumulado,
                    "FAT_FXA": fat_fxo,
                    "FAT_ACUM": fat_acumulado,
